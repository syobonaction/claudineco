...
export default function Services() {
    return (
        <div id="services" className="mb-32 p-4 lg:pt-16 drop-shadow-lg rounded-lg mx-auto w-full bg-white border-gray-300 grid text-center lg:text-left">
            <h2 className="mb-16 text-center text-blue-900 text-3xl font-bold leading-none tracking-tight md:text-4xl lg:text-5xl">
                Services
            </h2>
            <div className="lg:grid lg:grid-cols-2 auto-cols-max">
                <Service 
                    imageUrl="/visa.png"
